...
import { Cloud, Droplets, Sprout, CloudRain, Trash2 } from "lucide-react";
  ...
  const topics = [
    {
      ...
      description: "Learn about air quality, causes, and how to keep our air clean!",
    },
    {
      title: "Water Pollution",
      icon: Droplets,
      color: "from-eco-ocean to-secondary",
      description: "Discover how to protect our precious water resources.",
    },
    {
      title: "Sustainable Development",
      icon: Sprout,
      color: "from-primary to-eco-leaf",
      description: "Explore ways to grow without harming our planet.",
    },
    {
      title: "Rainwater Harvesting",
      icon: CloudRain,
      color: "from-eco-blue to-primary",
      description: "Save water for a brighter tomorrow!",
    },
    {
      title: "Waste Management",
      icon: Trash2,
      color: "from-accent to-eco-green",
      description: "Turn trash into treasure with smart waste handling.",
    },
  ];
        ...
        {topics.map((topic, index) => (
          ...
          >
            ...
            <CardFooter className="p-6 pt-0 flex gap-3">
              ...
              <Button
                variant="outline"
                className="flex-1 rounded-xl border-2 hover:bg-accent hover:text-accent-foreground hover:border-accent transition-all duration-300"
              >
                🎯 Quiz
              </Button>
            </CardFooter>
